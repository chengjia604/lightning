...
func Create_html(url, domname map[string][]string, jsdata map[string]bool, name string, host string) {
	//创建模板
	file, err := os.OpenFile(filepath.Join(rpath(), "tem/"+name+".html"), os.O_WRONLY|os.O_CREATE|os.O_TRUNC, 0666)
	if err != nil {
		panic("生成模板错误")
	}
	defer file.Close()
	...
	//js_data.WriteString("var domname=document.getElementById(\"domname\");\nvar jsurl=document.getElementById(\"js\")\nvar urls=document.getElementById(\"url\")\ndomname.onclick=function(){\n    document.querySelector('#tb tbody').innerHTML = \"\";\n    for(let [key,value] of Object.entries(domnameurl[0])){\n        let html= `\n        <tr>\n        <td><a href=\"${key}\">${key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n        $('#tb tbody').append(html);\n    }\n}\njsurl.onclick=function (){\n    document.querySelector('#tb tbody').innerHTML = \"\";\n    for(let [key,value] of Object.entries(jsname[0])){\n        let html= `\n        <tr>\n        <td>${key}</td>\n         <td>${value}</td>\n        </tr>\n        `\n        $('#tb tbody').append(html);\n    }\n}\nurls.onclick=function (){\n    document.querySelector('#tb tbody').innerHTML = \"\";\n    for(let [key,value] of Object.entries(url[0])){\n        if (key.substring(0,5)==='https'||key.substring(0,4)==='http'){\n            let html= `\n        <tr>\n        <td>\n        <a href='${key}'>${key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n            $('#tb tbody').append(html);\n        }else{\n            let html= `\n        <tr>\n        <td>\n        <a href='${host+key}'>${host+key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n            $('#tb tbody').append(html);\n        }\n    }\n}\nfor(let [key,value] of Object.entries(url[0])){\n    if (key.substring(0,5)==='https'||key.substring(0,4)==='http'){\n        let html= `\n        <tr>\n        <td>\n        <a href='${key}'>${key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n        $('#tb tbody').append(html);\n    }else{\n        let html= `\n        <tr>\n        <td>\n        <a href='${host+key}'>${host+key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n        $('#tb tbody').append(html);\n    }\n        \n}")
	js_data.WriteString("var domname=document.getElementById(\"domname\");\nvar jsurl=document.getElementById(\"js\")\nvar urls=document.getElementById(\"url\")\ndomname.onclick=function(){\n    document.querySelector('#tb tbody').innerHTML = \"\";\n    for(let [key,value] of Object.entries(domnameurl[0])){\n        let html= `\n        <tr>\n        <td><a href=\"${key}\" target=\"_blank\">${key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n        $('#tb tbody').append(html);\n    }\n}\njsurl.onclick=function (){\n    document.querySelector('#tb tbody').innerHTML = \"\";\n    for(let [key,value] of Object.entries(jsname[0])){\n        let html= `\n        <tr>\n        <td>${key}</td>\n         <td>${value}</td>\n        </tr>\n        `\n        $('#tb tbody').append(html);\n    }\n}\nurls.onclick=function (){\n    document.querySelector('#tb tbody').innerHTML = \"\";\n    for(let [key,value] of Object.entries(url[0])){\n        if (key.substring(0,5)==='https'||key.substring(0,4)==='http'){\n            let html= `\n        <tr>\n        <td>\n        <a href='${key}' target=\"_blank\">${key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n            $('#tb tbody').append(html);\n        }else{\n            let html= `\n        <tr>\n        <td>\n        <a href='${host+key}' target=\"_blank\">${host+key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n            $('#tb tbody').append(html);\n        }\n    }\n}\nfor(let [key,value] of Object.entries(url[0])){\n    if (key.substring(0,5)==='https'||key.substring(0,4)==='http'){\n        let html= `\n        <tr>\n        <td>\n        <a href='${key}' target=\"_blank\">${key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n        $('#tb tbody').append(html);\n    }else{\n        let html= `\n        <tr>\n        <td>\n        <a href='${host+key}' target=\"_blank\">${host+key}</a></td>\n         <td>${value}</td>\n        </tr>\n        `\n        $('#tb tbody').append(html);\n    }\n        \n}")
	js_data.Flush()
}
